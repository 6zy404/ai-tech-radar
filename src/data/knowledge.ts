...
export const knowledgeItems: KnowledgeItem[] = [
  ...
  },
  {
    ...
    summary: "为什么外部知识检索会改变答案的质量、时效性和信任边界。",
    content:
  ...
  },
  {
    ...
    summary: "一种经典的运营习惯：定义预期结果、观察失败、不断收紧闭环。",
    content:
  ...
  },
  {
    ...
    summary: "当产品由 AI 驱动时，延迟、可靠性、成本和可控性这些权衡依然适用。",
    content:
  ...
  },
  {
    ...
    summary: "当输出会影响客户、运营或对外沟通时，人工检查点仍然不可或缺。",
    content:
  ...
  },
  {
    ...
    summary: "把概念和关联显式建模，能让某些推理更易于检查和维护。",
    content:
  ...
  },
  {
    ...
    summary: "根据延迟、隐私、成本和任务复杂度来选择模型规模，而不是只看名气。",
    content:
  ...
  },
  {
    ...
    summary: "当用户必须等待语音、检索或漫长的多步操作时，交互设计也随之改变。",
    content:
  ...
  },
  {
    ...
    summary: "小而可见的闭环，比目标模糊的大版本发布更能让团队快速学习。",
    content:
